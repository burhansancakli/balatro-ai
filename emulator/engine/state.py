...
:func:`~engine.run_init.initialize_run` (creation) and
:func:`~engine.game.step` (mutation).  This module documents
...
- **init** = :func:`~engine.run_init.init_game_object`
- **run_init** = :func:`~engine.run_init.initialize_run`
- **stakes** = :func:`~engine.stakes.apply_stake_modifiers`
- **back** = :meth:`~engine.back.Back.apply_to_run`
- **challenge** = :func:`~engine.challenges.apply_challenge`
- **voucher** = :func:`~engine.vouchers.apply_voucher`
- **game** = :func:`~engine.game.step` (various handlers)
- **runner** = :func:`~engine.runner.simulate_run`
- **round** = :func:`~engine.run_init.start_round`
- **scoring** = :func:`~engine.scoring.score_hand`
- **economy** = :func:`~engine.economy.calculate_round_earnings`
- **shop** = shop population / reroll helpers in ``game.py``
- **tags** = :func:`~engine.tags.assign_ante_blinds`
- **lifecycle** = :func:`~engine.round_lifecycle.process_round_end_cards`
...
:func:`~engine.run_init.start_round`.
...
Flags checked by :func:`~engine.hand_eval.evaluate_hand` when
