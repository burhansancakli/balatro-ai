...
from emulator.engine.data.prototypes import BACKS


class Back:
    """Runtime wrapper around a :class:`~engine.data.prototypes.BackProto`.
    ...
    def apply_to_run(self, game_state: dict[str, Any]) -> dict[str, Any]:
        ...
        :func:`~engine.deck_builder.build_deck`.  The returned dict
