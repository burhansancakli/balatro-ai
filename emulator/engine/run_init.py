...
from emulator.engine.back import Back
from emulator.engine.challenges import apply_challenge
...
from emulator.engine.round_lifecycle import reset_round_targets
from emulator.engine.stakes import apply_stake_modifiers
...
def initialize_run(
    ...
    *,
    ...
    2. Set stake
    3. Apply stake modifiers (:func:`~engine.stakes.apply_stake_modifiers`)
    4. Apply back mutations (:meth:`~engine.back.Back.apply_to_run`)
    ...
    7. Initialize :class:`~engine.rng.PseudoRandom`
    8. Generate first ante (boss, tags, voucher)
    9. Build deck (:func:`~engine.deck_builder.build_deck`)
    ...
    # 9. Build deck
    # -----------------------------------------------------------------------
    from emulator.engine.deck_builder import build_deck
