...
from emulator.engine.data.hands import HandType
from emulator.engine.data.prototypes import TAGS
...
class Tag:
    ...
    def apply(
        ...
        **kwargs: Any,
        ...
        rng:
            Active :class:`~engine.rng.PseudoRandom` instance.
        ...
        **kwargs:
        ...
        if context == "immediate":
            ...
            if self.key == "tag_orbital":
                ...
                from emulator.engine.data.hands import HAND_BASE
...
def generate_blind_tags(
    ...
    Calls :func:`~engine.pools.pick_card_from_pool` twice with the
    ...
    *game_state*.
    ...
    rng:
        Live :class:`~engine.rng.PseudoRandom` instance.  Each
    ...
    """
    from emulator.engine.pools import pick_card_from_pool
...
def assign_ante_blinds(
    ...
    * ``game_state["round_resets"]["blind_tags"]`` is set to
    ...
    from emulator.engine.pools import pick_card_from_pool
    from emulator.engine.vouchers import get_next_voucher_key
