...
from emulator.engine.consumables import _resolve_consumable_config, can_use_consumable
from emulator.env.game_spec import FactoredAction  # noqa: F401 — re-export
