...
from emulator.env.game_spec import GameActionMask, GameObservation, GameSpec
from emulator.env.observation import encode_observation
...
class BalatroEnvironment:
    ...
    Implements the :class:`~env.game_spec.GameEnvironment` protocol
